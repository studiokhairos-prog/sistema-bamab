...
<?php }
function admin_footer(): void {?></main><footer class="admin-brand-footer"><img src="../<?=e(setting('logo_path','assets/brasao_bamab_2026.png'))?>" alt="Brasão"><div><strong><?=e(setting('site_name','BAMAB'))?></strong><span><?=e(setting('site_subtitle','BANDA AMARAL BRASIL'))?> · Sistema Interno · v<?=e(APP_VERSION)?></span></div></footer><script src="../<?=e(app_asset('assets/admin.js'))?>"></script></body></html><?php }
